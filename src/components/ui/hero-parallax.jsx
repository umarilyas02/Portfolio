...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className={`${isMobile ? (scrolled ? 'h-[120vh]' : 'h-[60vh]') : 'h-[300vh]'} py-20 md:py-40 overflow-hidden  antialiased relative flex flex-col self-auto perspective-[1000px] transform-3d`}
    >
